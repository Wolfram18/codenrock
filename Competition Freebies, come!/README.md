...
def main():
    for line in sys.stdin:
        numbers = [int(item) for item in line.split()]
        print(get_unique_sum(numbers[1:len(numbers)-1]))
...
## Ёлка
### Задание
В предвкушении нового года преподаватель по программированию попросил студентов первого курса нарисовать ёлку высотой *N*. На вход подаётся целое положительное число, нарисуйте ёлку в соответствии с заданной высотой.  
